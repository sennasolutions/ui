                ...
                Alpine.data('tinymceMedia', (value, options, mediaId) => ({
                    ...
                    init() {
                        ...
                        tinymce.init({
                            ...
                            content_style: 'body { font-family:Helvetica,Arial,sans-serif; font-size:15px } img { max-width: 100%; height: auto; } span.mce-preview-object[data-mce-object="iframe"] { display: inline-block; max-width: 100% !important; height: auto !important; aspect-ratio: 16/9; overflow: hidden; } span.mce-preview-object[data-mce-object="iframe"] iframe { display: block; width: 100%; height: 100%; }',
                        ...
                        Livewire.on(mediaId + ':editor:insert', (id, url, hash, type) => {
                            if (component.editorInstance) {
                                ...
                                if (type === 'video-link') {
                                    ...
                                    html = '<iframe src="' + embedUrl + '" width="560" height="315" style="max-width:100%; height:auto; aspect-ratio:16/9;" frameborder="0" allowfullscreen></iframe>';
                                } else {
